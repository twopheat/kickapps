      ...
      <ul className="row">
        <li className="btn neu btn-default mr-1">
          <Link to="/"><svg className="bi bi-map"datatoggle="tooltip" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <title>Home</title></svg></Link>
        </li>
        <li className="btn neu btn-default mr-1">
          <Link to="/about"><svg className="bi bi-people" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <title>About</title></svg></Link>
        </li>
        <li className="btn neu btn-default mr-1">
          <Link to="/contact"><svg className="bi bi-arrow-left-right" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <title>Contact</title></svg></Link>
        </li>
        <li className="btn neu btn-default mr-1">
          <Link to="/portfolio"><svg className="bi bi-cloud" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <title>Portfolio</title></svg></Link>
        </li>
